...
#define KEYMAP( \
    ...
    K3A, K3B, K3C,           K3E, K3F,           K3H, K3I, K3J  \
) { \
    ...
    { KC_##K3A, KC_##K3B, KC_##K3C, KC_NO,    KC_##K3E, KC_##K3F, KC_NO,    KC_##K3H, KC_##K3I, KC_##K3J, KC_##K3K }  \
}
