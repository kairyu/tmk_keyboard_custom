...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KEYMAP(
        ...
        VOLD,MUTE,VOLU,APP, TRNS,TRNS,P1,  P2,  P3,  PENT,TRNS,TRNS,TRNS,FN8, FN5,  \
        FN3, FN2, FN4, TRNS,TRNS,TRNS,P0,  FN10,PDOT,PENT,PENT,FN11,FN6, FN9, FN7),
    /* Keymap 2: Fn Layer
     * ,-----------------------------------------------------------.
     * | F1| F2| F3| F4| F5| F6|Num|  /|  *| F7| F8| F9|F10|F11|F12|
     * |---+---+---+---+---+---+---+---+---+---+---+---+---+---+---|
    ...
    KEYMAP(
        ...
        MPRV,MPLY,MNXT,MSTP,TRNS,TRNS,P4,  P5,  P6,  PPLS,TRNS,BTLD,TRNS,TRNS,TRNS, \
        VOLD,MUTE,VOLU,APP, TRNS,TRNS,P1,  P2,  P3,  PENT,TRNS,TRNS,TRNS,FN8, FN5,  \
        FN3, FN2, FN4, FN11,TRNS,TRNS,P0,  FN10,PDOT,PENT,PENT,TRNS,FN6, FN9, FN7),
    /* Keymap 3: Fn Layer
     * ,-----------------------------------------------------------.
     * | F1| F2| F3| F4| F5| F6|Num|  /|  *| F7| F8| F9|F10|F11|F12|
     * |---+---+---+---+---+---+---+---+---+---+---+---+---+---+---|
    ...
    KEYMAP(
        ...
        MPRV,MPLY,MNXT,MSTP,TRNS,TRNS,P4,  P5,  P6,  PPLS,TRNS,BTLD,TRNS,TRNS,TRNS, \
        VOLD,MUTE,VOLU,APP, TRNS,TRNS,P1,  P2,  P3,  PENT,TRNS,TRNS,TRNS,FN8, FN5,  \
        FN3, FN2, FN4, TRNS,TRNS,TRNS,P0,  FN10,PDOT,PENT,PENT,TRNS,FN6, FN9, FN7),
};
...
const uint16_t fn_actions[] PROGMEM = {
    ...
    [8] = ACTION_FUNCTION_OPT(AF_RGB_LED, AF_RGB_LED_INCREASE_BRIGHTNESS),
