...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    /* Keymap 0:
     * ,-----------------------------------------------------------------------.
     * | F1| F2|Esc|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|Backsp |Num|
     * |---+---+-----------------------------------------------------------+---|
     * | F3| F4|Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|    \|  7|
     * |---+---+-----------------------------------------------------------+---|
     * | F5| F6|Caps  |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return  |  4|
     * |---+---+-----------------------------------------------------------+---|
     * | F7| F8|Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift |Fn0|  1|
     * |---+---+-----------------------------------------------------------+---|
     * | F9|F10|Ctrl|Gui |Alt |         Space          |Alt |Fn0 |Gui |Ctrl|  0|
     * `-----------------------------------------------------------------------'
     */
    KEYMAP_VERB(
